...
<?php else: ?>
    <div class="selos-add" ng-controller="RelatedSealsController">
        <div ng-if="relations.length > 0 || (isEditable && seals.length > 0)" class="widget">
            <h3 ng-if="isEditable && canRelateSeal" text-align="left" vertical-align="bottom">Selos Aplicados <div ng-click="editbox.open('sealsAvailable', $event)" class="hltip editable editable-empty" title="Adicionar selo relacionado"></div></h3>
