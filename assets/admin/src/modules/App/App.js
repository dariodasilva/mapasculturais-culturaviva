...
angular.module('AppAdmin.directives', ['AppAdmin.services', 'ngMessages', 'ngSanitize']);
angular.module('AppAdmin.controllers', ['AppAdmin.services']);
...
AppRun.$inject = ['$q', '$rootScope', '$state', '$document', 'UsuarioSrv'];
 ...
 * @returns {undefined}
 */
function AppRun($q, $rootScope, $state, $document, UsuarioSrv) {
